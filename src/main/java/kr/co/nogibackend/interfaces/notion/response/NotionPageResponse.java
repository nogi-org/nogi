...
import kr.co.nogibackend.interfaces.notion.response.content.NotionCoverResponse;
import kr.co.nogibackend.interfaces.notion.response.content.NotionIconResponse;
...
import kr.co.nogibackend.interfaces.notion.response.property.NotionNogiProperties;
...
public class NotionPageResponse {
  ...
  private NotionIconResponse icon;
  private NotionCoverResponse cover;
