...
import static kr.co.nogibackend.domain.notion.dto.constant.NotionPropertyKey.STATUS;
import static kr.co.nogibackend.domain.notion.dto.constant.NotionPropertyValue.STATUS_DONE;
import static kr.co.nogibackend.domain.notion.dto.constant.NotionPropertyValue.STATUS_FAILED;

import java.util.HashMap;
import java.util.Map;
import kr.co.nogibackend.domain.notion.dto.constant.NotionPropertyValue;
