...
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.CODE;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.DIVIDER;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.HEADING1;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.HEADING2;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.HEADING3;
...
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.PARAGRAPH;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.QUOTE;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.TABLE;
import static kr.co.nogibackend.domain.notion.info.NotionBlockInfo.TODO;
...
import kr.co.nogibackend.domain.notion.info.NotionBlockConversionInfo;
