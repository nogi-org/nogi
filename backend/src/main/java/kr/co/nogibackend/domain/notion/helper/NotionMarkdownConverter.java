...
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.CODE;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.DIVIDER;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.HEADING1;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.HEADING2;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.HEADING3;
...
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.PARAGRAPH;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.QUOTE;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.TABLE;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.TODO;
import static kr.co.nogibackend.domain.notion.result.NotionBlockResult.TOGGLE;
import static kr.co.nogibackend.global.response.code.NotionResponseCode.F_PROCESS_MARKDOWN;
...
public class NotionMarkdownConverter {
	 ...
	 * <h1>마크다운 변환</h1>
	 */
	public NotionBlockConversionResult convert(
			List<NotionBlockResult> blocks
			, String githubOwner
	) {
		try {
	 ...
	 * <h1>블럭별 마크다운 생성</h1>
	 */
	public NotionBlockConversionResult buildBlock(
			List<NotionBlockResult> blocks
			, String githubOwner
		...
		for (NotionBlockResult block : blocks) {
		...
		return new NotionBlockConversionResult(markdown.toString(), images);
	}
	...
	public String buildToggle(
		...
		if (toggle.hasChildren()) {
			NotionBlockConversionResult childrenBlockMarkdown =
