...
import static kr.co.nogibackend.global.response.code.CommonResponseCode.F_VALIDATION;

import java.util.List;
import kr.co.nogibackend.global.response.service.Response;
import kr.co.nogibackend.global.response.service.ValidationFailResultSet;
