package kr.co.nogibackend.interfaces.github.response;
...
public record UserValidateGithubResponse(
	...
	public static UserValidateGithubResponse from(GithubValidateResult info) {
		UserResponse userResponse = UserResponse.from(info.user());
		GithubUserResponse githubUserResponse = GithubUserResponse.from(info.githubUserDetailResult());
		...
		boolean isOwnerValid = info.user().githubOwner()
				.equalsIgnoreCase(info.githubUserDetailResult().login());
	...
	public record GithubUserResponse(
		...
		public static GithubUserResponse from(GithubUserDetailResult info) {
	...
	public record GithubRepositoryResponse(
		...
		public static GithubRepositoryResponse from(GithubRepoResult info) {
	...
	public record GithubOwnerResponse(
		...
		public static GithubOwnerResponse from(GithubRepoResult.GithubOwnerInfo info) {
	...
	public record GithubLicenseResponse(
		...
		public static GithubLicenseResponse from(GithubRepoResult.GithubLicenseInfo info) {
	...
	public record GithubPermissionsResponse(
		...
		public static GithubPermissionsResponse from(GithubRepoResult.GithubPermissions info) {
	...
	public record GithubEmailResponse(
		...
		public static GithubEmailResponse from(GithubUserEmailResult info) {
