...
public class GithubClientImpl implements GithubClient {
  ...
  @Override
  public GithubRepoInfo updateRepository(String owner, String repo, GithubUpdateRepoRequest request,
      String token) {
  ...
  @Override
  public GithubBlobInfo createBlob(String owner, String repo, GithubCreateBlobRequest request,
      String token) {
  ...
  @Override
  public GithubCreateCommitInfo createCommit(String owner, String repo,
  ...
  @Override
  public GithubIssueInfo createIssue(String owner, String repo, GithubCreateIssueRequest request,
      String token) {
