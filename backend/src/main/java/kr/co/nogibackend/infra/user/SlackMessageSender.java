...
import kr.co.nogibackend.domain.user.UserSender;
...
@Slf4j
@Component
public class SlackMessageSender implements UserSender {
  ...
  @Override
  public void sendSignUpNotification(Long userId, String ownerName) {
